...
parametric=s:P
user_delete=s:1
files=s:3DX\Farfields\Farfield (f=5) [1].ffs
...
parametric=s:P
user_delete=s:1
files=s:3DX\Farfields\Farfield (f=2.4) [1].ffs
...
files=s:power (f=5)_1.m3d
files=s:power (f=5) [1]_1.rex
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\0D Results\Export Farfields to 3DEXPERIENCE Content_1
files=s:Export Farfields to 3DEXPERIENCE Content_1.rd0
files=s:Export Farfields to 3DEXPERIENCE Content_1.rd0
